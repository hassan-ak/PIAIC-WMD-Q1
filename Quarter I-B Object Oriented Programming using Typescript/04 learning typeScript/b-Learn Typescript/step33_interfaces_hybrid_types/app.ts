//An example of hybrid type is an object that acts as both a function and an object,
...
//When interacting with 3rd-party JavaScript, you may need to use patterns like the
