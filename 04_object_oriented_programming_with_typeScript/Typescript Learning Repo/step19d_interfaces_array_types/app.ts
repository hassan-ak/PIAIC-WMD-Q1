...
/************************************************/
// We can use interfaces to describe an array also,
// please note this is different from Java or C#
...
let myDictionary3: Dictionary2 = { first: 'Bob', second: 'Fred', length: '2' };
var first = myDictionary3['first'];

/************************************************/
// It is possible to support both types of index,
// with the restriction that the type returned from the numeric index must be a
// subtype of the type returned from the string index.
