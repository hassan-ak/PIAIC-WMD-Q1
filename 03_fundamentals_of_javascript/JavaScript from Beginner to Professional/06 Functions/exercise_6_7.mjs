...
function looper1(countDownValue) {
  console.log('Countdown : ', countDownValue);
  if (countDownValue < 1) {
    return;
  } else {
    looper1(--countDownValue);
  }
}
looper1(startVariable);
console.log(' ');
function looper2(countDownValue) {
  console.log('Countdown : ', countDownValue);
  if (countDownValue > 0) {
    --countDownValue;
    return looper2(countDownValue);
  } else {
    return;
  }
}
looper2(startVariable);
