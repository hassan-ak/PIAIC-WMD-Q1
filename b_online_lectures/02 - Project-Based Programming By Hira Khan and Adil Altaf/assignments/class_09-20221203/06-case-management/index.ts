...
export const cases: Case[] = [
	{
		...
		// --- chnaged from array to string
		defendant: "Glynn Batson and Southplains Land Corporation",
		// --- chnaged from number to string
		id: "841710",
	...
	{
		// Removed extra property
		// amusing: true,
		// --- changed value from "ny state" to "state"
		court: "state",
		defendant: "PepsiCo, Inc.",
		// --- chnaged from object to array
		decided: new Date("August 5, 1999"),
		// corrected property name from ids to id
